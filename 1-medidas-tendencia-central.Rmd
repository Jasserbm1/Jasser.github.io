...
author:
    name: "[Jasser Bretón Mora Duarte](https://Jasserbm1.github.io)"
...
[Fuente (2022)](https://es.wikipedia.org/wiki/Medidas_de_tendencia_central "Fuente (2022)")
...
> Definición: "En el ámbito de la estadística, la **mediana** (del latín *mediānus* 'del medio) representa el valor de la variable de posición central en un conjunto de datos ordenados"

[Fuente (2022)](https://es.wikipedia.org/wiki/Mediana_(estad%C3%ADstica) "Fuente (2022)")
...
> Definición: "la media aritmética, también llamada promedio o media, es un conjunto infinito de números, es el valor característico de una serie de datos cuantitativos, objeto de estudio que parte del principio de la esperanza matemática o valor esperado, se obtiene a partir de la suma de todos sus valores dividida entre el número total de sumandos"

[Fuente (2022)](https://es.wikipedia.org/wiki/Media_aritm%C3%A9tica "Fuente (2022)")
...
[Fuente (2022)](https://es.wikipedia.org/wiki/Moda_(estad%C3%ADstica) "Fuente (2022)")
